...
public class KafkaController {
     ...
     */
    private KafkaMessageSender<MessageSentToKafkaEvent> kafkaSendMessageService;

    private final ExecutorService executorService = Executors.newFixedThreadPool(3);


    @Autowired
    public KafkaController(KafkaMessageSender<MessageSentToKafkaEvent> kafkaSendMessageService) {
    ...
    public void sendMessageWithHeaders(@RequestBody DemoServiceMessage message) {
        ...
        MessageSentToKafkaEvent event = MessageSentToKafkaEvent.newBuilder()
